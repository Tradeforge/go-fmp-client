...
func (t *SECFilingType) UnmarshalJSON(data []byte) error {
	var filingType SECFormType
	if err := filingType.UnmarshalJSON(data); err != nil {
		return err
	}
	*t = SECFilingType{
		Form:          filingType.Name(),
		Specification: filingType.Specification(),
	}
	return nil
}
...
func (t *SECFormType) UnmarshalJSON(data []byte) error {
	*t = SECFormType(string(data))
	return nil
}
