...
const (
	...
	ListSP500IndexConstituentsPath    = "/stable/sp500-constituent"
	ListNasdaqIndexConstituentsPath   = "/stable/nasdaq-constituent"
	ListDowJonesIndexConstituentsPath = "/stable/dowjones-constituent"
)
...
func (tc *TickerClient) ListSP500IndexConstituents(ctx context.Context, opts ...model.RequestOption) (model.ListIndexConstituentsResponse, error) {
	var res model.ListIndexConstituentsResponse
	_, err := tc.Call(ctx, http.MethodGet, ListSP500IndexConstituentsPath, nil, &res, opts...)
	return res, err
}

func (tc *TickerClient) ListNasdaqIndexConstituents(ctx context.Context, opts ...model.RequestOption) (model.ListIndexConstituentsResponse, error) {
	var res model.ListIndexConstituentsResponse
	_, err := tc.Call(ctx, http.MethodGet, ListNasdaqIndexConstituentsPath, nil, &res, opts...)
	return res, err
}

func (tc *TickerClient) ListDowJonesIndexConstituents(ctx context.Context, opts ...model.RequestOption) (model.ListIndexConstituentsResponse, error) {
	var res model.ListIndexConstituentsResponse
	_, err := tc.Call(ctx, http.MethodGet, ListDowJonesIndexConstituentsPath, nil, &res, opts...)
	return res, err
}
